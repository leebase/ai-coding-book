...
|----------|-----------|------|
| TinyClaw methodology | Build from scratch with small primitives; validate before scale | 2026-03-15 |
...
- **Working Directory**: ./ai-coding-book
- **Project Name**: ai-coding-book
