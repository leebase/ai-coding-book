#!/usr/bin/env python3
"""Build Markdown, EPUB, DOCX, and PDF for The Business Growth Playbook."""
...
MD_PATH = BOOK_DIR / "the-business-growth-playbook.md"
COVER_PATH = BOOK_DIR / "BusinessGrowthPlaybook.png"
EPUB_PATH = BOOK_DIR / "the-business-growth-playbook.epub"
DOCX_PATH = BOOK_DIR / "the-business-growth-playbook.docx"
PDF_PATH = BOOK_DIR / "the-business-growth-playbook.pdf"

TITLE = "The Business Growth Playbook"
SUBTITLE = "How Leaders Use AI to Amplify People and Grow the Business"
AUTHOR = "Lee Harrington"
PUBLISHER = "Leebase Press"
BOOK_ID = str(uuid.uuid4())

DARK = RGBColor(0x14, 0x26, 0x4A)
MID = RGBColor(0x2E, 0x59, 0x8C)
...
CHAPTER_ORDER = [
    "introduction-the-wrong-win.md",
    "chapter-1-the-efficiency-story-everybody-understands.md",
    "chapter-2-what-gets-lost-when-you-cut-too-deep.md",
    "chapter-3-the-multiplier-model.md",
    "chapter-4-who-ai-replaces-who-it-multiplies.md",
    "chapter-5-the-people-you-didnt-know-you-had.md",
    "chapter-6-every-ai-program-needs-a-growth-thesis.md",
    "chapter-7-stop-funding-the-wrong-work.md",
    "chapter-8-build-the-capacity-portfolio.md",
    "chapter-9-redesign-the-program.md",
    "chapter-10-talent-and-operating-model.md",
    "chapter-11-the-leadership-conversation.md",
    "chapter-12-the-amplified-enterprise.md",
    "conclusion-dont-cut-your-way-to-the-future.md",
]

EPUB_CSS = """body{font-family:Georgia,"Times New Roman",serif;font-size:1em;line-height:1.65;color:#1a1a1a;margin:0 5%;}
h1{font-family:"Helvetica Neue",Arial,sans-serif;font-size:1.7em;font-weight:bold;color:#14264A;margin-top:2em;margin-bottom:0.5em;page-break-before:always;}
h2{font-family:"Helvetica Neue",Arial,sans-serif;font-size:1.2em;font-weight:bold;color:#2E598C;margin-top:1.6em;margin-bottom:0.4em;}
...
pre{background:#f5f5f5;border:1px solid #ddd;border-left:3px solid #2E598C;padding:.75em 1em;font-family:"Courier New",Courier,monospace;font-size:.85em;white-space:pre-wrap;word-wrap:break-word;margin:.8em 0;}
code{font-family:"Courier New",Courier,monospace;font-size:.88em;background:#f5f5f5;padding:.1em .3em;}
blockquote{border-left:4px solid #2E598C;background:#eef4fb;margin:1em 0;padding:.6em 1em;color:#333;}
...
th{background:#2E598C;color:white;padding:.4em .6em;text-align:left;}
    ...
    for line in text.splitlines():
        ...
        is_book_heading = (
            ...
            and (
                ...
                or re.match(r"^# Chapter \d+\b", line)
            )
        )
...
<package version="3.0" xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:rights>Copyright © 2026 {AUTHOR}. All rights reserved.</dc:rights>
    <meta name="cover" content="cover-image"/>
    <meta property="dcterms:modified">2026-03-28T00:00:00Z</meta>
  </metadata>
  <manifest>
...
def render_markdown_docx(doc: Document, md_text: str) -> None:
...
def build_docx(text: str) -> None:
    ...
    core.author = AUTHOR
    core.subject = "Business leadership handbook for AI amplification"
    core.comments = "Generated from the-business-growth-playbook.md"
    add_title_pages(doc)
    render_markdown_docx(doc, text)
    doc.save(str(DOCX_PATH))


def build_styles_pdf():
    ...
    styles.add(
        ParagraphStyle(
            ...
            fontName="Helvetica",
            fontSize=15,
            textColor=colors.HexColor("#2E598C"),
        )
    )
    styles.add(
        ParagraphStyle(
            ...
            leftIndent=18,
            borderPadding=6,
            borderColor=colors.HexColor("#2E598C"),
            borderWidth=1,
            borderLeft=True,
...
def render_story_pdf(md_text: str, styles):
    story = []
    story.append(Image(str(COVER_PATH), width=5.2 * inch, height=7.15 * inch))
...
def build_pdf(text: str) -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        author=AUTHOR,
        subject="Business leadership handbook for AI amplification",
    )
    doc.build(render_story_pdf(text, styles))


def main() -> None:
    text = build_combined_markdown()
    build_epub(text)
    build_docx(text)
    build_pdf(text)
