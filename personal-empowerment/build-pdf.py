#!/usr/bin/env python3
"""Build PDF for the personal empowerment book."""
...
from build_common import AUTHOR, BOOK_DIR, COVER_PATH, MANUSCRIPT_PATH, PDF_PATH, SUBTITLE, TITLE, assemble_manuscript, assemble_markdown_book
...
def main() -> None:
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        source_path = temp_dir_path / "personal-empowerment-export.md"
