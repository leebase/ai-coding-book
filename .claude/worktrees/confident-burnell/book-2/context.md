...
|------|--------|-------|-----------|
| 1 | Introduction chapter | AI | Draft approved |
| 2 | Conclusion chapter | AI | Draft approved |
| 3 | Continuity pass — all 11 chapters | AI | No thread breaks found |
| 4 | Copyedit pass | AI | Clean |
| 5 | Document all harness sections for spin-off editions | AI | Swap points catalogued |
