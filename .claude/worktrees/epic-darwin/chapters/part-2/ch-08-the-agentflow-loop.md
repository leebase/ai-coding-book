...
Skip the loop. Open Antigravity and start a new agent session (new conversation icon at the top of the agent sidebar). Type:
...
Open a new agent session (new conversation icon at the top of the agent sidebar). Give the agent context and the requirement:
...
# In the Antigravity file explorer, open tasks.json and replace its contents
# with an empty array: []
...
Add a new entry to decisions.md. In the Antigravity file explorer, open `decisions.md` and add:
